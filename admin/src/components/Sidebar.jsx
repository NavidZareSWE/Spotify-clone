  ...
  return (
    <div className="bg-[#003A10] min-h-screen pl-[4vw]">
      ...
      <div className="flex flex-col gap-5 mt-10">
        <NavLink
          to={"/add-song"}
          className="flex items-center gap-2.5 text-gray-800 bg-white border border-black p-2 pr-[max(8vw, 10px)] drop-shadow-[-3px_3px_#00FF5B] text-sm font-medium"
        >
        ...
        <NavLink
          ...
          className="flex items-center gap-2.5 text-gray-800 bg-white border border-black p-2 pr-[max(8vw, 10px)] drop-shadow-[-3px_3px_#00FF5B] text-sm font-medium"
        >
          <img src={assets.song_icon} className="w-5" alt="List Songs" />
        ...
        <NavLink
          ...
          className="flex items-center gap-2.5 text-gray-800 bg-white border border-black p-2 pr-[max(8vw, 10px)] drop-shadow-[-3px_3px_#00FF5B] text-sm font-medium"
        >
          <img src={assets.album_icon} className="w-5" alt="List Albums" />
